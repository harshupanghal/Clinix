    ...
    public partial class Testing : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SymptomKeywords", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueBy = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowUps_Status_DueBy",
                table: "FollowUps",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxMessages_Processed_OccurredAtUtc",
                table: "OutboxMessages",
                columns: new[] { "Processed", "OccurredAtUtc" });
